//Base component from https://github.com/theanam/react-awesome-lightbox.
        ...
        <div className="lb-container">
          ...
          <div className="lb-header" style={{ justifyContent: buttonAlign }}>
            ...
            <Cond condition={allowZoom}>
              <div
                title="Zoom Out"
                className={`lb-button zoomout ${zoom <= 1 ? "disabled" : ""}`}
